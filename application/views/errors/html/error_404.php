...
<title>404 Page Not Found</title>
  ...
  <link rel="shortcut icon" href="/ne_stenka/application/resources/user_resources/img/favicon/favicon.ico" type="image/x-icon">
  <link rel="apple-touch-icon" href="/ne_stenka/application/resources/user_resources/img/favicon/apple-touch-icon.png">
  <link rel="apple-touch-icon" sizes="72x72" href="/ne_stenka/application/resources/user_resources/img/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="114x114" href="/ne_stenka/application/resources/user_resources/img/favicon/apple-touch-icon-114x114.png">

  <link rel="stylesheet" href="/ne_stenka/application/resources/user_resources/libs/foundation/foundation.css">
  <link rel="stylesheet" href="/ne_stenka/application/resources/user_resources/css/fonts.css">
  <link rel="stylesheet" href="/ne_stenka/application/resources/user_resources/css/main.css">
    ...
    <div class="row header-info">
      ...
      <div class="header-info-wrappertop clear hide-for-large">
        ...
        <div class="header-info_logo column small-12 medium-6 large-3">
          <a href="/"><img src="/ne_stenka/application/resources/user_resources/img/logo.png" alt=""></a>
    ...
    <div class="row header-nav">
      <div class="column small-12 menu-centered clearfix">
        <ul class="menu">
          ...
          <li class=''><a href="#">Плиты перекрытия</a></li>
          <li class=''><a href="#">Клей и инструменты</a></li>
...
<section  style='background: #f3f5f8' class="pb130">
	...
	<div class="large-10 row small-12">
		<div class="column large-12 text-center">
			<img src="/ne_stenka/application/resources/user_resources/img/404.png">
...
<div class='row expanded large-12 main-footer'>
	...
	<div class="row expanded small-12 medium-12 large-12 large-centered pt20" style='background: #0b0e1d'> 
		<div class="row large-10">
			...
			<div class="column small-12 medium-4 text-right">
				<img src="/ne_stenka/application/resources/user_resources/img/visaMaestroMC.png">
			</div>
			<div class="column small-12 medium-4 text-right">
  ...
  <script src="/ne_stenka/application/resources/user_resources/libs/modernizr/modernizr.js" charset="utf-8"></script>
  <script src="/ne_stenka/application/resources/user_resources/libs/jquery/jquery-2.2.2.min.js" charset="utf-8"></script>
  <script src="/ne_stenka/application/resources/user_resources/libs/foundation/foundation.min.js" charset="utf-8"></script>
  <!--  
  ...
  <script src="/ne_stenka/application/resources/user_resources/js/common.js" charset="utf-8"></script>
