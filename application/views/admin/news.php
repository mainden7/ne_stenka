...
<div id="addNews" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<form class="form-horizontal mt25 ml50" action="<?php echo site_url(); ?>index.php/admin_panel/news" method="POST"   enctype="multipart/form-data">
						...
						<tbody>
							...
							foreach($data['news'] AS $article) { ?>
								<tr>
									...
									<td class="color-blue-grey-lighter"><?php echo $article['description']; ?></td>
									...
									<td class="table-icon-cell">
										<a href="<?php echo site_url(); ?>admin_panel/delete_product/<?php echo $article['id']; ?>" onclick="return window.confirm('Вы уверены?')"><i class="font-icon font-icon-trash"></i></a>
									</td>
								</tr>
											...
											<form class="form-horizontal mt25 ml50" action="<?php echo site_url(); ?>admin_panel/edit_product" method="POST"   enctype="multipart/form-data">
												<div class="modal-body">
													<div class="form-group">
														...
														<input type="text" class='form-control' name="name" value="<?php echo $article['name'] ?>" placeholder="name">
													</div>
													<div class="form-group">
														<label>Описание</label>
														<div class="summernote-theme-1">
															<textarea class="summernote" name='description'><?php echo $article['description']; ?></textarea>
														</div>
													</div>
												</div>
												<div class="modal-footer">
