...
<div id="addProduct" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<form class="form-horizontal mt25 ml50" action="/admin_panel/products" method="POST"   enctype="multipart/form-data">
				<div class="modal-body">
					...
					<div class="form-group">
						<a href="" class="show-city dropdown-toggle">Цены</i></a>
					</div>
						...
						<div class="row">
							<?php foreach ($data['cities'] as $city) { ?>
								<div class='form-group col-md-4'>
									...
									<input type="text" class='form-control' name='<?php echo $city['name'] ?>' value="" placeholder="цена">
								</div>		
								<?php	} ?>
							</div>
						</div>
										...
										<div id="editProduct<?php echo $product['id']; ?>" class="modal fade" role="dialog">
											<div class="modal-dialog">
												...
												<div class="modal-content">
													...
													<form class="form-horizontal mt25 ml50" action="/admin_panel/edit_product" method="POST"   enctype="multipart/form-data">
														<div class="modal-body">
															<div class="form-group">
															...
															<div class="form-group">
																	...
																	<?php foreach ($data['cities'] as $city) { ?>
																		<div class='form-group col-md-4'>
																			...
																			<?php 
																			 ...
																			 ?>
																			<input type="text" class='form-control' name='<?php echo $city['name'] ?>' value="<?php echo trim($price) !=0 ? trim($price) : ''; ?>"
																			  placeholder="цена">
																		</div>		
																		<?php	} ?>
																	</div>
																...
																<div class="form-group">
																	...
																	<select name='category' class="">
																		<?php foreach ($data['categories'] as $category) { ?>
																			<option <?php echo $product['category'] == $category['name'] ? 'selected' : ''; ?> value='<?php echo $category['name']; ?>'><?php echo $category['name']; ?></option>
																		<?php } ?>
																	</select>
																	</div>
																	<div class="form-group" style='width: 200px'>
