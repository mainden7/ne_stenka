				...
				<div id="tabs-1" class="row large-12 pt80 pb80">
					...
					<div class="row large-12">
						...
						<div class="table-info-1  proposal-row-2 mb80">
							<h4>Цены указаны на марку блоков <b>d500</b> для города <a href='#'>Москва <i class='fa fa-sort-down'></i></a>, <a href="">Без упаковки на поддоне <i class='fa fa-sort-down'></i></a></h4>
							<table class="responsive">
								...
								<tbody>
									<tr>
										...
										<td class='br-none text-center'><i class='fa fa-shopping-basket fa-2x'></i></td>
									</tr>
								</tbody>
							</table>
						</div>
